...
if(isset($_POST['finalizar'])){
    ...
    if(!empty($idMesa)){
        ...
        if($results1 && $results2 && $results3 && $results4){
        	header('Location: ../../View/Funcionario/statusMesa2.php?status=mesaonline');
        }else{
        	header('Location: ../../View/Funcionario/statusMesa2.php?telas=vermesa&idMesa='. $idMesa .'&status=erro');
        }
